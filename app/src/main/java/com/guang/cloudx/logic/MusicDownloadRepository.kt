                        ...
                        try {
                            ...
                            AudioTagWriter.writeTags(
                                ...
                                AudioTagWriter.TagInfo(
                                    ...
                                    coverFile = tmpCover,
                                    lyrics = createLyrics(MusicNetwork.getLyrics(music.id.toString(), cookie), music)
                                )
                            )
                            tmpCover.delete()
                            ...
                            // ========= 7. 写入 .lrc =========
                            if (isSaveLrc) {
                                val lrcText = createLyrics(MusicNetwork.getLyrics(music.id.toString(), cookie), music)
